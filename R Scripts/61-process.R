...
setwd("/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/NSS_61")
...
# Rural Data 
##########################
rural_data <- read.csv("rural-61.csv")
...
rural_df <- rural_data_final[,c(1,61)]
...
saveRDS(mydata2_rural, file = "/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/rural61.rds")
...
#Urban Data
#########################
urban_data <- read.csv("urban-61.csv")
...
urban_df <- urban_data_final[,c(1,61)]
...
saveRDS(mydata2_urban, file = "/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/urban61.rds")
