...
setwd("/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/NSS_50")
...
# Rural Data 
##########################
rural_data <- read.csv("rural-50.csv")
...
rural_df <- rural_data_final[,c(1,44)]
...
saveRDS(mydata2_rural, file = "/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/rural50.rds")
...
#Urban Data
#########################
urban_data <- read.csv("urban-50.csv")
...
urban_df <- urban_data_final[,c(1,44)]
...
saveRDS(mydata2_urban, file = "/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/urban50.rds")
