...
setwd("/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/NSS_55")
...
# Rural Data 
##########################
rural_data <- read.csv("rural-55.csv")
...
rural_df <- rural_data_final[,c(1,42)]
...
saveRDS(mydata2_rural, file = "/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/rural55.rds")
...
#Urban Data
#########################
urban_data <- read.csv("urban-55.csv")
...
urban_df <- urban_data_final[,c(1,42)]
...
saveRDS(mydata2_urban, file = "/media/kushal/001A3CCE1A3CC308/kushal/research/nsso-employment/revised-nsso/urban55.rds")
